...
class ReceivePaymentPage extends StatefulWidget {
  ...
  const ReceivePaymentPage({super.key, required this.debt});
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await supabase.from('transactions').insert({
          ...
          'type': 'income',
          'amount': amount,
          'description': 'Pago recibido de ${widget.debt['person_name']}',
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Pago recibido correctamente')),
          );
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text('Deuda de: ${widget.debt['person_name']}'),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(labelText: 'Ingresar en'),
